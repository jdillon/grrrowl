...
/**
 * Tests for {@link GrowlFactory}.
 *
 * @author <a href="mailto:jason@planet57.com">Jason Dillon</a>
 */
class GrowlFactoryTest
    extends GrowlTestSupport
{
    @Test
    void testGrowlNull() {
        System.setProperty(GrowlFactory.TYPE, NullGrowl.class.name)
    ...
    void testGrowlAppleScript() {
        System.setProperty(GrowlFactory.TYPE, AppleScriptGrowl.class.name)
        Growler growl = new Growler(getClass().name, "foo")
        growl.growl("foo", "Test AppleScript", "applescript")
    }
}