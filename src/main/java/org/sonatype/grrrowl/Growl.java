...
public class Growl
{
    ...
    public Growl(final String productName) {
    ...
    private static ID invoke(final String className, final String selector, Object... args) {
        assert className != null;
        assert selector != null;
        return invoke(Foundation.getClass(className), selector, args);
    }

    private static ID invoke(final ID id, final String selector, Object... args) {
        assert id != null;
        assert selector != null;
        return invoke(id, Foundation.createSelector(selector), args);
    }

    private static ID invoke(final ID id, final Selector selector, Object... args) {
        assert id != null;
        assert selector != null;
